...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Section Qui nous sommes optimisée mobile */}
      <section
        id="who-we-are"
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-6 sm:mt-8">
              ...
              >
                <Smartphone
                  ...
                  aria-hidden="true"
                />
                <span className="font-medium text-white text-xs sm:text-sm">Application mobile</span>
              </div>
              <div
                className="flex items-center gap-2 bg-white/20 px-3 sm:px-4 py-2 rounded-full border border-white/30 transition-all duration-300 hover:bg-white/30 hover:scale-105 hover:shadow-lg group"
                role="presentation"
              >
                <Gift
                  ...
                  aria-hidden="true"
                />
                <span className="font-medium text-white text-xs sm:text-sm">Récompenses</span>
              </div>
              <div
                className="flex items-center gap-2 bg-white/20 px-3 sm:px-4 py-2 rounded-full border border-white/30 transition-all duration-300 hover:bg-white/30 hover:scale-105 hover:shadow-lg group"
                role="presentation"
              >
                <Coffee
                  ...
                  aria-hidden="true"
                />
                <span className="font-medium text-white text-xs sm:text-sm">Commerces locaux</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Section À propos optimisée mobile */}
      <section
        id="about"
      ...
      >
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-6 sm:gap-8 py-8 sm:py-12 md:grid-cols-2 lg:grid-cols-3 lg:gap-12">
            <article className="flex flex-col items-center space-y-4 rounded-lg border p-4 sm:p-6 shadow-sm transition-all duration-500 hover:shadow-xl bg-white hover:scale-105 hover:-translate-y-2 group">
              <div
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-lg sm:text-xl font-bold">Visibilité accrue</h3>
            ...
            <article className="flex flex-col items-center space-y-4 rounded-lg border p-4 sm:p-6 shadow-sm transition-all duration-500 hover:shadow-xl bg-white hover:scale-105 hover:-translate-y-2 group">
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-lg sm:text-xl font-bold">Communauté engagée</h3>
                <p className="text-muted-foreground text-sm sm:text-base">
            ...
            <article className="flex flex-col items-center space-y-4 rounded-lg border p-4 sm:p-6 shadow-sm transition-all duration-500 hover:shadow-xl bg-white hover:scale-105 hover:-translate-y-2 group md:col-span-2 lg:col-span-1">
              <div
                className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full bg-gosholo-dark-teal transition-all duration-300 group-hover:scale-110 group-hover:rotate-6"
                role="presentation"
              >
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-lg sm:text-xl font-bold">Impact économique</h3>
                <p className="text-muted-foreground text-sm sm:text-base">
                ...
                <div className="border-2 border-dashed border-white p-4 sm:p-6 rounded-lg bg-white">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 p-2">
                      <MapPin className="h-4 w-4 sm:h-5 sm:w-5 text-gosholo-orange flex-shrink-0" aria-hidden="true" />
                ...
                >
                  <div id="rules-content" className="p-4 sm:p-6 border-t text-sm overflow-y-auto max-h-80">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        <h4 className="font-bold text-gosholo-dark-teal mb-2 text-sm sm:text-base">3. Admissibilité</h4>
                        <ul className="list-disc pl-5 space-y-1 text-xs sm:text-sm">
                      ...
                      <div>
                        <h4 className="font-bold text-gosholo-dark-teal mb-2 text-sm sm:text-base">7. Consentement</h4>
                        <ul className="list-disc pl-5 space-y-1 text-xs sm:text-sm">
                          <li>
      ...
      {/* Pastille flottante optimisée mobile */}
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50">
        <div className="bg-gosholo-orange text-white px-3 sm:px-4 py-2 rounded-full shadow-lg border-2 border-white flex items-center gap-2 transition-all duration-300 hover:scale-105 hover:shadow-xl group max-w-[calc(100vw-2rem)]">
          ...
          <span className="text-xs sm:text-sm font-medium whitespace-nowrap">Site en construction</span>
